...
static const char LOADMAP[] PROGMEM= "nav_msgs/LoadMap";

    static const char nav_msgs_LoadMapRequest_type[] PROGMEM= "nav_msgs/LoadMapRequest";
    static const char nav_msgs_LoadMapRequest_md5[] PROGMEM= "3813ba1ae85fbcd4dc88c90f1426b90b";
  class LoadMapRequest : public ros::Msg
  {
    ...
    virtual const char * getMD5() override { return nav_msgs_LoadMapRequest_md5; };

  };

    static const char nav_msgs_LoadMapResponse_type[] PROGMEM= "nav_msgs/LoadMapResponse";
    static const char nav_msgs_LoadMapResponse_md5[] PROGMEM= "079b9c828e9f7c1918bf86932fd7267e";
  class LoadMapResponse : public ros::Msg
  {
    ...
    virtual const char * getType() override { return LOADMAP; };
    virtual const char * getMD5() override { return nav_msgs_LoadMapResponse_md5; };
